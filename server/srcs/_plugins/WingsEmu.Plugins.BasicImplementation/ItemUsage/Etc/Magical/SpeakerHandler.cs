...
public class SpeakerHandler : IItemHandler
{
    private readonly IGameLanguageService _languageService;

    public SpeakerHandler(IGameLanguageService languageService) => _languageService = languageService;

    public ItemType ItemType => ItemType.Magical;
    public long[] Effects => new long[] { 15 };
