...
{
    public class IceBreakerMatchmakingResult : IMatchmakingResult
    {
        public IceBreakerMatchmakingResult(List<Tuple<IGameEventConfiguration, List<IClientSession>>> sessions, Dictionary<GameDialogKey, List<IClientSession>> refusedSessions)
        {
            Sessions = sessions;
